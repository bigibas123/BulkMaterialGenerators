...
{
    [CustomEditor(typeof(Runtime.TextureArrayConverter))]
    [CanEditMultipleObjects]
    public class TextureArrayConverterEditor : UnityEditor.Editor
    {
        ...
        {
            _slotsProp =
                serializedObject.FindProperty(nameof(Runtime.TextureArrayConverter.slots));
        }
